...
const LoginForm = ({ db }) => {
  ...
  const { setUserRole } = useUserRole(); // Retrieve setUserRole from context
  ...
  return (
    <div className="mainpage">
      ...
      <Form
        ...
        style={{
          backgroundColor: "rgb(159 159 159 / 81%)",
          border: "2px solid var(--generic-info-card-border-color)",
        }}
      >
        <h2>Σύνδεση</h2>
